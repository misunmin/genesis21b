...
interest (QOIs) are directly relevant to design work at national laboratories
and in industry, where we are partnering with several firms, including
{\bf Kairos}, {\bf TerraPower}, and {\bf Westinghouse} 
(Appendix \ref{collaboration_letters}).
In these systems, fluid motion is the {\em principal transport mechanism} for
energy from core processes (fission/fusion reactions) to heat exchangers, where
