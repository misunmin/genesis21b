...
energy systems.
  Phase I demonstrator problems are illustrated in Fig.
...
{\em (iii)} heat-transfer enhancement through optimized wire-coil-inserts.
  These demonstrators exemplify components central to DOE’s advanced energy
programs and are designed to permit ready exploration, development, and
validation of the agentic workflows in the space, where
