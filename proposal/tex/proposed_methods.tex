...
using direct numerical or large-eddy simulations (DNS or LES) of 
turbulence.\footnote{Broadly, 
we employ Nek5000/RS for incompressible applications
and MFEM for compressible flows.}
...
per configuration \cite{ricardo26b}.
...
traditional discretizations (e.g., a {\bf 32$\times$ gain} compared to 2nd-order finite
