...
per configuration. {\color{red}CHECK MMS citation}
...
%
{\color{red}CHECK:MMS, ricardo version doesn't have this? just double-checking. 
...
\noindent {\bf Effort Breakdown:}
   ...
   {\bf U. Mich.}-model development; device optimization \$110K;
