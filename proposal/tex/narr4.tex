...
{\bf variational autoencoders (VAEs)} for compression of high-dimensional flow fields [20,23], 
and {\bf conditional latent diffusion models} [25] to learn distributions across operating regimes. 
...
This effort will employ a hybrid strategy combining {\bf Bayesian optimization} [17], 
{\bf derivative-free optimization methods}, and {\bf reinforcement learning} [9]. 
