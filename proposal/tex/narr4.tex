...
As illustrated in Fig. \ref{fig:fm1}, the {\em Phase I} goal is to develop a training
...
and solution data before encoding.  
Because derivatives are critical to pressure-drop and
thermal flux QOIs, {\em spatial derivatives} will
also be encoded during training in order to bypass the need for a fine
mesh when differentiating the surrogate solution.
