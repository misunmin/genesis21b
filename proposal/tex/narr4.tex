...
(i) optimization of pressure-drop and heat-transfer
performance in \textbf{wire-wrapped fuel-rod bundles};
...
%\item Optimization of pressure drop and heat transfer in
%\textbf{wire-wrapped fuel-rod bundles}
%\item A \textbf{miniapp for inertially confined fusion}
%\item Optimization of \textbf{wire-coil inserts} for
%heat-transfer enhancement in beam-line cooling systems
%\end{enumerate}
%
%
...
with simulation degrees of freedom (DOFs) ranging 
from approximately $10^7$ to $10^12$~\cite{gb23,gb25mfem}.
}
