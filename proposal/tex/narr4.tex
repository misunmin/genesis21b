...
turbulent flow in liquid metal fast reactors, including everything from isolated subassemblies
\cite{fischer08a,Dai2025WireWrapped61Pin,shaver37pin,shavernacie}[{\color{blue}other}] 
to full cores~\cite{sc22,gb23}[{\color{blue}other3}].
...
or the NE Divison cluster, {\em Nek5k}, as part of ongoing studies.  The
generation of wire-wrapped fuel bundle geometries has been fully automated so
that model training at new points in the wire-wrap diameter / pitch space
...
used for model training. {\bf CHECK Dillon!!}
...
%vspace{-2pt}
\caption{\label{fig:nacie}
Experimental-NekRS data comparison of pin wall temperatures 
for a wire-wrapped bundle \cite{shavernacie}.
}
\vspace{-7pt}
