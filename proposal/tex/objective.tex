...
directly aligns with the chosen focus topic on AI–enabled
...
simulations by at least $5\times$ relative to brute-force CFD-based
design exploration.
\\[-3ex]
...
end-to-end automated design workflows with $5\times$ acceleration
...
models that generalize across geometries and operating conditions. 
  The amortized training will yield reduced design-cycle cost, accelerate innovation
