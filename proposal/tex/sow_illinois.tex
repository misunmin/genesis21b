...
\newcommand{\Title}{Foundation Models for Automated Design of Energy Flow Systems}
...
\usepackage[top=2in,bottom=2in,left=1.5in,right=1.5in]{geometry} % Set margins
...
\section{Statement of Work~---~Illinois}
\medskip

The objective of this project is to develop a geometry-aware,
foundation-model–driven, agentic AI framework for the rapid prediction,
optimization, and control of thermal–fluid transport in DOE-relevant energy
systems. The proposed work at Illinois includes assisting with integrating
high-fidelity simulation data, advanced machine learning architectures, and
closed-loop optimization workflows.

The project will involve several interconnected components to build foundation
models and agentic systems for thermal-fluid simulations.  The work at Illinois
will primarily focus on the first component of the research plan, which
involves the development of a geometry-aware thermal–fluid foundation model.
The work at Illinois will also contribute to the other components of the
project as well as cross-domain validation and integration into the Genesis
Mission ecosystem.
