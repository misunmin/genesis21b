\begin{figure}[t]
    \centering
   %\includegraphics[width=0.69\linewidth]{../figs/method_w_labels.png}
   %\hspace{.5in}\includegraphics[width=0.64\linewidth]{../figs/method_w_labels.png}
    \hspace{.5in}\includegraphics[width=0.69\linewidth]{../figs/method_w_labels.png}
\caption{
\small
