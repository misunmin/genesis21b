...
cores~\cite{sc22,gb23}.  The majority of these simulation datasets are 
available and summarized in the nuclear design literature.  In particular
we have access to high-fidelity 3D datasets for adiabatic flow in a
61-pin assembly over a range of Reynolds numbers
...
datasets are corraborated by experimental that demonstrate
their validity. 
  Similarly, the MFEM team has simulation data from model ICF simulations in
wide regimes, geometries and resolutions.  Both Nek and MFEM have
infrastructures to automatically produce additional data, some of which is
currently being generated on existing compute resources on OLCF Frontier, ALCF
Aurora, and the NE Divison cluster, {\em Nek5k}, as part of ongoing studies.
