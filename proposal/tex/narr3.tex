...
wire-coil inserts for heat transfer enhancement in beam-line devices.   
These test cases were selected because of the availability of reliable
simulation and experimental data and the fact that they can be scaled over a
range of sizes, with the number of simulation degrees-of-freedom (DOFs) ranging
from $\sim 10^7$ to $10^{12}$ \cite{gb23,gb25mfem}.
