...
geometry-aware foundation model for thermal-fluid prediction.
Building on prior work on foundation
models~\cite{Vishwasrao2026AgenticPDE}, as well as simulation and experimental
data from wire-wrapped bundles~\cite{collins22} and related
configurations such as spacer grids, pebble beds, and twisted tubes, will be
mapped to a common latent space independent of mesh topology. 
...
heat transfer and pressure losses. The model will combine graph-based
representations of geometry, variational autoencoders for compressing
