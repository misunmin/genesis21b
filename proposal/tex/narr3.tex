...
scalable preconditioners gives them a competitive edge over traditional codes
...
\noindent
{\bf Effort Breakdown:}
ANL-reactor TF data; model validation; device optimization \$100K;
LLNL-ICF data; model validation \$100K;
U. Mich.-model development; device optimization \$100K;
PSU-reactor TF data; model validation \$50K;
UIUC-heat-exchanger data; model validation \$50K.
