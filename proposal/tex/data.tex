...
cores~\cite{sc22,gb23}.  
   The majority of these datasets are 
available and summarized in the nuclear design literature.  
...
\cite{Dai2025WireWrapped61Pin} and flow in a 19-pin assembly under
...
wide regimes, geometries and resolutions.  
Both Nek and MFEM have infrastructures to automatically produce additional
data, some of which is being generated on  
OLCF Frontier, ALCF Aurora, and the NE Divison cluster, {\em Nek5k},
...
which will also be used for model training.  
  The generation of wire-wrapped fuel bundle geometries has been fully automated
so new points in the wire-wrap geometry space can be readily integrated into the
training data to control uncertainty.


% The generation of wire-wrapped fuel bundle geometries has been fully automated
% so that model training at new points in the wire-wrap diameter / pitch space is
% straightforward.  We are able to generate data for single-pin, fully periodic
% domains to cover a broad range of conditions quickly which can be integrated in
% to the training data to control uncertainty.
