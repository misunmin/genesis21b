...
metal fast reactors, including everything from isolated subassemblies
...
corroborated with Nek5000/RS studies by Kaneko \cite{kaneko22}, who also 
examined nearby geometric configurations such as arrays of ring inserts.
These cases are relatively small and can be run on one or two GPUs for 
one hour to generate requisite QOIs (e.g., Nusselt number, Nu, which is the
...
a benefit that that should be found automatically by the proposed AI
