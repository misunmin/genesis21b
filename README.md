...
From: Cruz Garcia, Elizabeth <ecruzgarcia@anl.gov>
Sent: Wednesday, April 8, 2026 8:14 PM
To: Min, Misun <mmin@mcs.anl.gov>
Cc: Leyffer, Sven <leyffer@anl.gov>; Shaver, Dillon R. <dshaver@anl.gov>; Feller, Daniel <fellerd@anl.gov>; Tobin, Carolyn Aileen <cpeters@mcs.anl.gov>
Subject: Proposal Process (GM 21B submission)
...
2   ANL-1048 Approvals via SharePoint/BOX:
        Division Directors and PIs will receive email notifications when their review/approval is required on each ANL-1048.
        PI, RPE lead (Steve J.), and Division Director will need to electronically sign and approve each ANL-1048.
            Lead Proposals: ANL-1048s must be signed by EOD April 13. CELS Proposal Team (Lisa C.) will submit to SRO by April 14.
            Partner Proposals: ANL-1048s must be signed by EOD April 20. CELS Proposal Team (Lisa C.) will submit to SRO by April 21.
3   Grants.gov Workspaces:
        The Finance team will create corresponding workspaces for all approved proposals (Lead and Partner) – please do not create your own.
        Your local division finance manager and the CELS Proposal Team (Lisa C.) will be in contact with specifics for grants.gov for your divisions.
4   CELS Proposal Intake Form CELS Proposal Intake Form :
        We ask all PIs to submit this form for each Genesis application (both Lead and Partner)
        This helps capture key data that will be used in the application.
5   Lead applications:
        CELS Proposal Team (Lisa C.) will coordinate communications with all partners, subrecipients, and ANL key personnel for required proposal items.
6   Partner applications:
        CELS Proposal Team (Lisa C.) will coordinate communications and submit key documents to the Lead.
        Grants.gov submission is also required for Partner applications. CELS Proposal Team (Lisa C.) will coordinate.
7   Budget Entry:
...
```
From: lans-council <lans-council-bounces@lists.mcs.anl.gov> on behalf of Leyffer, Sven <leyffer@anl.gov>
Sent: Tuesday, April 7, 2026 12:04 PM
To: lans-council@mcs.anl.gov <lans-council@mcs.anl.gov>
Cc: Ross, Robert B. <rross@anl.gov>; Taylor, Valerie E. <vtaylor@anl.gov>
Subject: GM Proposal Resources
 
Hi all,
Below is some information that you might find useful for GM proposals:

    CELS proposal intake form (one per ANL-led or outside-led proposal): https://wordpress.cels.anl.gov/forms/cels-forms/cels-proposal-intake-form/
    Sven's latex template for GM proposal: https://www.overleaf.com/read/gccjqwcsbcfb#30b8a5 (please send me mistakes)
    Genesis Mission RFA Proposal Resources: https://anl.app.box.com/hubs/973892810?s=rafkma3mjgwyzxkrtshdxs8wiy4ypz8p
    Genesis Mission RFA: How to Submit at Argonne: https://my.anl.gov/genesis-mission-rfa
    Phase I budget period: July 1, 2026 - March 31, 2027
    ANL-led proposals: April 14, 2026: Submit full proposal package via your assigned Box folder to Proposal Development Group (PDG) 

I will collect this information on our LANS Council page. Please add material, as appropriate.
Cheers,
Sven
```
...
- Plans:
   - 4/07 Tue: [inputs](https://docs.google.com/document/d/1bEcsV_Lmntw-5kKw6bpyr3WBnqhkKWIiaI23DluNPdU/edit?tab=t.0) (current as of today)
